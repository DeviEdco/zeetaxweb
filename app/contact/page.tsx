  ...
  return (
    <div className="flex flex-col items-center gap-6 md:gap-9 lg:gap-[3.75rem] shrink-0 self-stretch py-9 md:py-16 lg:py-[5rem] px-4 md:px-6 lg:px-0  bg-[linear-gradient(180deg,rgba(255,255,255,0.16)_0.24%,rgba(255,255,255,0.16)_99.76%),radial-gradient(107.81%_107.81%_at_50%_-4.1%,#391DE8_0%,#3B1FE7_49.75%,#FFF_76.81%)]">
      ...
      <motion.div
        ...
        className="w-full max-w-[23.625rem] md:max-w-[41.9375rem] lg:max-w-[62.875rem] rounded-md bg-white shadow-[-4px_8px_8px_rgba(0,0,0,0.16)] backdrop-blur-[2px] p-4 md:p-6 lg:p-8 flex flex-col gap-4 md:gap-6"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 items-start">
          <div className="flex flex-col gap-3">
            <div className="flex items-start gap-3">
              ...
              <a
                href="tel:08619977179"
                className="text-black font-manrope text-sm md:text-base leading-[1.6] hover:underline"
              >
                Phone: 08619977179
              </a>
            </div>
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.98 }}
        className="flex cursor-pointer items-center justify-center gap-2 md:gap-4 pl-3 md:pl-5 px-1 md:px-2 py-1 md:py-2 rounded-full border border-white bg-[#363636] shadow-[0_4px_4px_rgba(0,0,0,0.25)] backdrop-blur-[5px]"
      >
        ...
        <div className="w-6 h-6 md:w-10 md:h-10 flex items-center justify-center rounded-full bg-white">
          <svg
            className="md:w-6 md:h-6 w-5 h-5 text-black"
            viewBox="0 0 24 24"
            fill="none"
